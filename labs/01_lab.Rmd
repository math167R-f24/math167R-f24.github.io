...
![R programming software interface on macOS displaying version and licensing details in the console.](figures/console.png)
...
![RStudio IDE with panels Source, Environments, Console, and Output showing a ggplot2 script and resulting scatter plot of engine displacement vs. highway mpg.](https://docs.posit.co/ide/user/ide/get-started/images/rstudio-panes-labeled.jpeg)
