...
#| out.width: "100%"
#| fig.align: "center"
#| fig-alt: "Line graph of cases from 1999 to 2000 in Afghanistan (0 cases), Brazil (increasing from 50,000 to 100,000 cases), and China (steady at 200,000 cases)."
...
#| out.width: "100%"
#| fig.align: "center"
#| fig-alt: "Stacked bar chart showing the count of various religious affiliations across different income brackets, with a legend detailing the color codes for each religion."
relig_income |>
...
#| out-width: "100%"
#| fig-align: "center"
#| fig-alt: "Line graph showing population growth from 2010 to 2020, starting at 310 million and rising steadily to just above 330 million."
US_pop |> 
...
```{r, echo = T, eval = T, error = T, fig.alt="Scatter plot showing population growth from 2010 to 2020."}
...
#| fig-width: 7
#| fig-height: 4.75
#| fig-alt: "Line graph showing population growth from 2010 to 2020, with population increasing steadily."
US_pop |> 
  select(-POPESTIMATE042020) |>
  pivot_longer(contains("POPESTIMATE"), 
               names_to = "Year",
...
#| fig-width: 7
#| fig-height: 4.75
#| fig-alt: "Line graph showing population trends from 2010 to 2020 for Midwest (red), Northeast (green), South (teal), and West (purple) regions."
state_population |> 
  filter(SUMLEV == "020") |>
  select(-POPESTIMATE042020) |>
  pivot_longer(contains("POPESTIMATE"), 
...
#| out.width: "100%"
#| fig.align: "center"
#| fig-alt: "Line graph of CPI from 1970 to 2020 with noticeable peaks in the early 1980s and a sharp rise after 2020."
cpi |>
  pivot_longer(cols = `1970`:`2022`,
               names_to = "Year", 
               values_to = "CPI") |>
