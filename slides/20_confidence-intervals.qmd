...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Line graph showing the average value decreasing from 6.0 to 3.5 over 1000 rolls, with a red line oscillating around the value of 3.5 and a blue horizontal line at 3.5 as a baseline."
set.seed(1028)
...
#| warning: FALSE
#| message: FALSE
#| fig-alt: ": Histogram with a density plot overlay, x-axis labeled 'Xbar,' y-axis labeled 'density.'"
library(ggplot2)
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Histogram with vertical black bars and a red density plot line overlaid, depicting a bell-shaped distribution. The x-axis is labeled 'Xbar,' and the y-axis is labeled 'density'."
n <- 5
...
#| warning: FALSE
#| message: FALSE
#| fig-alt: "Histogram with black bars and a red density curve"
n <- 5
...
#| warning: FALSE
#| message: FALSE
#| fig-alt: "Horizontal error bar plot with teal and red bars, and a central black line at Y equals 10."
library(tidyverse)
...
#| eval: TRUE
#| cache: TRUE
#| fig.alt: "Comparison of standard normal density and t-density for various values of degrees of freedom, indicating that as degrees of freedom increases, the t-density approaches the standard normal"
library(ggplot2)
dat <- data.frame(x = seq(-4, 4, length.out = 500)) 
ggplot(dat, aes(x = x)) +
  geom_function(fun = dnorm, aes(color = "normal"),
                linewidth = 1.4) +
  geom_function(fun = dt, args = list(df = 1), aes(color = "t, df = 1"),
                linewidth = 1.4) + 
  geom_function(fun = dt, args = list(df = 5), aes(color = "t, df = 5"),
                linewidth = 1.4) + 
  geom_function(fun = dt, args = list(df = 20), aes(color = "t, df = 20"),
                linewidth = 1.4) +
  theme_bw(base_size = 22) + ylab("f(x)") + ggtitle("Comparison of normal and t densities")
```
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Histogram of precipitation frequency distribution with values on the x-axis from 0 to 70 and frequency on the y-axis from 0 to 25."
head(precip)
hist(precip)
```
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Normal Q-Q Plot showing precipitation data for 70 US cities, with points plotted against theoretical quantiles and a reference line indicating expected normal distribution."
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Normal Q-Q Plot comparing Penguin bill lengths to theoretical quantiles."
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Histogram showing the distribution of penguin bill lengths in millimeters."
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Normal Q-Q plot comparing Penguin bill lengths to theoretical quantiles, with points closely following a diagonal line."
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Histogram of adelie$bill_length_mm with frequencies ranging from 0 to 30 on the y-axis and bill lengths from 32 to 46 mm on the x-axis."
...
* When $n$ is small, **but $X_1,\ldots, X_n$ are normally distributed, ** you can use a $t$-interval since 
$$T=\frac{\overline{X}_n-\mu}{S/\sqrt{n}}$$
