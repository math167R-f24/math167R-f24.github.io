...
#| engine: 'tikz'
#| fig-align: "center"
\begin{tikzpicture}[thick,scale=1, every node/.style={scale=3}]
\node at (-4, 0) {};
\node at (30, 0) {};
...
\node at (25, 1) {1};
\draw (24, 2) rectangle (26, 4);
\node at (25, 3) {1};
\draw (24, 4) rectangle (26, 6);
\node at (25, 5) {1};
\draw (24, 6) rectangle (26, 8);
\node at (25, 7) {5};
\draw (22, 4) rectangle (24, 6);
\node at (23, 5) {5};
...
## Efron's dice {.smaller}

If one player chooses $A$ and the other chooses $B$, what is the probability that $A$ wins? We can write this as 
\begin{align*}
