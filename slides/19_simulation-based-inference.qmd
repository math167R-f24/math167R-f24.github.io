...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Histogram of sampling distribution of mean of 100 normal variables with mean 0 and standard deviation 1 with frequency on the vertical axis and Xbar on the horizontal axis."
set.seed(123)
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Histogram of sampling distribution of mean of 100 exponential variables with parameter 1 with frequency on the vertical axis and Xbar on the horizontal axis."
set.seed(123)
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Histogram showing the sampling distribution of the mean of 100 Poisson(1) variables with the peak centered around Xbar equal to 1.0."
set.seed(123)
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Three side-by-side histograms showing normal, exponential, and Poisson distributions."
set.seed(123)
Xbar_normal <- replicate(10000, mean(rnorm(10)))
Xbar_exp <- replicate(10000, mean(rexp(10, rate = 1)))
Xbar_poisson <- replicate(10000, mean(rpois(10, lambda = 1)))
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Three histograms representing normal, exponential, and Poisson distributions."
set.seed(123)
Xmax_normal <- replicate(10000, max(rnorm(10)))
Xmax_exp <- replicate(10000, max(rexp(10, rate = 1)))
Xmax_poisson <- replicate(10000, max(rpois(10, lambda = 1)))
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Three histograms showing the frequency distributions of squared values from normal, exponential, and Poisson distributions."
set.seed(123)
Xbar_normal <- replicate(10000, mean(rnorm(10) ^ 2))
Xbar_exp <- replicate(10000, mean(rexp(10, rate = 1) ^ 2))
Xbar_poisson <- replicate(10000, mean(rpois(10, lambda = 1) ^ 2))
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Bar chart showing counts for years 1970, 1990, 2000, 2010, and 2020. "
library(tidyverse)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Two bar charts comparing 'Original sample' and 'Resample' data by year (1970, 1990, 2010). The y-axis is labeled 'count,' and the x-axis is labeled 'year.' "
pennies_combined <- 
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Bar chart showing count distribution over sampled years 1989, 1992, 1995, and 1998, with highest count of 8 in 1995."
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Bar graph showing a distribution with a peak around 1995."
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Histogram showing the frequency distribution of sample means with vertical red lines marking 1990 and 2000."
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Histogram of sampling distribution of mean of exponentials with red overlay for density"
set.seed(123)
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Histogram of the bootstrap sample means"
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Density plot of three sources: Bootstrap (red), Parametric (Exp) (green), and Parametric (Normal) (blue)."
library(ggplot2)
plot_dat <-
  data.frame(Xbar = c(Xbar_exp - 1, bootstrap_Xbar - mean(X)),
             source = rep(c("Parametric (Exp)", "Bootstrap"), each = 10000))
