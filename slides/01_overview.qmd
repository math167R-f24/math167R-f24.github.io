...
+==================+==================================================================================================================+
| **Lectures**     | Weekly on Monday and Wednesday, 12-1:15pm in MH235.                                                              |
+------------------+------------------------------------------------------------------------------------------------------------------+
| **Office Hours** | M 3-4pm and W 10:30-11:30am in MH426                                                                             |
+------------------+------------------------------------------------------------------------------------------------------------------+
...
+-------------+------------------------------------------------------------------+
| In-person   | M 3-4pm and W 10:30-11:30am in MH426 or email for an appointment |
+-------------+------------------------------------------------------------------+
| Zoom        | By appointment                                                   |
+-------------+------------------------------------------------------------------+
...
```{r, echo = T, warning = F, fig.cap = "Scatter plot showing the positive correlation between flipper length in millimeters and body mass in grams, with a blue line of best fit."}
library(ggplot2)
