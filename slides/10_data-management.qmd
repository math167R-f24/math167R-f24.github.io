...
![](images/join-inner.png){fig-alt="Data pivoting representation showing two connected diamonds with grids on the left, transforming into a structured table format on the right." height="90"}

![](images/join-outer.png){fig-alt="Three diagrams showing the process of Left Join, Right Join, and Full Join with matrices and resulting merged matrices." height="360"}
...
#| out-width: "100%"
#| fig-align: "center"
#| fig-alt: "Scatter plot showing the relationship between wind speed (0 to 40) and departure delay (0 to 900), with numerous black dots concentrated in the lower range of the y-axis."
flights |> 
...
```{r, echo = F, eval = T, fig.alt="Scatter plot comparing 2021 and 2010 median incomes for California counties, with a positive trend line."}
income_combined <- income_2010 |>
  left_join(income_2021, by = c("GEOID", "NAME"))
ggplot(income_combined, aes(x = medincome_2010, y = medincome_2021)) +
  geom_point() + 
...
#| echo: TRUE
#| eval: TRUE
#| fig-alt: "Line graph showing population growth from 2010 to 2020."
...
#| echo: TRUE
#| eval: TRUE
#| fig-alt: "Line graph showing population growth from 2010 to 2020. Population increases from 3.10e+08 to just above 3.30e+08."
