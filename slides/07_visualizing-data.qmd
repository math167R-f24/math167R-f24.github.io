...
```{r, echo = F, eval = T, fig.alt = "Grid of twelve scatterplots, each labeled and showcasing different dot formations such as circles, lines, slants, and a star shape."}
datasaurus_dozen |>
  group_by(dataset) |> 
...
```{r, echo = T, eval = T, fig.alt="Bar chart showing movie genres: Action 600, Adventure 500, Comedy 700, Drama 1000, Horror 300."}
...
```{r, echo = T, eval = T, fig.alt = "Bar chart showing movie genre distribution in the Tidy Tuesday dataset: Action around 600, Adventure slightly below 600, Comedy around 800, Drama around 1000, and Horror slightly below 400."}
barplot(
...
```{r, echo = T, eval = T, fig.alt = "Pie chart showing categories: Adventure, Action, Horror, Drama, and Comedy, with width of slice representing count."}
...
```{r, echo = T, eval = T, fig.alt = "Bar chart showing the distribution of worldwide gross of movies."}
hist(
...
```{r, echo = T, eval = T, fig.alt = "Box plot showing the distribution of worldwide gross earnings with a red box, black whiskers, and numerous black circular outliers."}
boxplot(
  x = movies$worldwide_gross, 
...
```{r, echo = T, eval = T, fig.alt = "Boxplot showing the distribution of production budget data with outliers."}
boxplot(
...
```{r, echo = T, eval = F, fig.alt = "Scatter plot of worldwide gross on the x-axis versus production budget on the y-axis, indicating positive relationship between budget and gross."}
plot(
  x = movies$production_budget, 
...
```{r, echo = F, eval = T, fig.alt = "Scatter plot of worldwide gross on the x-axis versus production budget on the y-axis, indicating positive relationship between budget and gross."}
plot(
  x = movies$production_budget, 
  y = movies$worldwide_gross, 
  main = "Worldwide Gross vs. Production Budget",
...
```{r, echo = T, eval = F, fig.alt = "Parallel boxplots of worldwide gross. There is one for each genre, indicating the Action and Adventure genres have higher grosses on average."}
...
```{r, echo = F, eval = T, fig.alt = "Parallel boxplots of worldwide gross. There is one for each genre, indicating the Action and Adventure genres have higher grosses on average."}
boxplot(worldwide_gross ~ genre,
        data = movies, 
        main = "Distribution of Worldwide Gross by Genre",
        xlab = "Worldwide Gross ($)",
...
```{r, echo = T, eval = T, fig.alt="Stacked bar chart of movie counts by MPAA rating and genre, showing that the most movies are in the R rating."}
...
::: {.column width="50%"}
```{r, echo = FALSE, eval = T, fig.height = 3.5, fig.width = 4, fig.alt="Light-gray rectangle."}
ggplot(data = movies) 
```
:::
:::
...
::: {.column width="50%"}
```{r, echo = FALSE, eval = T, fig.height = 3.5, fig.width = 4, fig.alt = "Blank graph with vertical gridlines and x-axis labeled 'production_budget'."}
ggplot(data = movies,
       aes(x = production_budget)) 
```
:::
...
::: {.column width="50%"}
```{r, echo = FALSE, eval = T, fig.height = 3.5, fig.width = 4, fig.alt ="Histogram showing the count of production budgets, with most values on the lower end and the amount of movies gradually decreasing as the budget increases."}
ggplot(data = movies,
       aes(x = production_budget)) +
  geom_histogram()
```
...
::: {.column width="50%"}
```{r, echo = FALSE, eval = T, fig.height = 3.5, fig.width = 4, fig.alt ="Histogram showing the count of production budgets, with most values on the lower end and the amount of movies gradually decreasing as the budget increases. The color has been changed to red."}
ggplot(data = movies,
       aes(x = production_budget)) +
  geom_histogram(fill = 'red')
```
...
::: {.column width="50%"}
```{r, echo = FALSE, eval = T, fig.height = 3.5, fig.width = 4,  fig.alt ="Histogram showing the count of production budgets, with most values on the lower end and the amount of movies gradually decreasing as the budget increases. Labels have been added to the axes and title."}
ggplot(data = movies,
       aes(x = production_budget)) +
  geom_histogram(fill = 'red') + 
  xlab("Budget ($)") +
...
::: {.column width="50%"}
```{r, echo = FALSE, eval = T, fig.height = 3.5, fig.width = 4, fig.alt = "Scatter plot showing a positive relationship between production budget and worldwide gross revenue for action and comedy movies."}
ggplot(data = action_comedy,
       aes(x = production_budget, y = worldwide_gross)) +
  geom_point()
```
...
::: {.column width="50%"}
```{r, echo = FALSE, eval = T, fig.height = 3.5, fig.width = 4, fig.alt = "Scatter plot showing a positive relationship between production budget and worldwide gross revenue for action and comedy movies. The points have been made red and labels and titles have been added."}
ggplot(data = action_comedy,
       aes(x = production_budget, y = worldwide_gross)) +
  geom_point(color = 'red', alpha = 0.5)  +
  xlab("Production Budget ($)") +
...
::: {.column width="45%"}
```{r, echo = FALSE, eval = T, fig.height = 3.5, fig.width = 4, fig.alt = "Scatter plot showing a positive relationship between production budget and worldwide gross revenue for action and comedy movies. Now, the color of each point tells what genre the movie is. In general, action movies have higher budgets and higher grosses than comedy movies."}
ggplot(data = action_comedy,
       aes(x = production_budget, y = worldwide_gross, color = genre)) +
  geom_point(alpha = 0.5)  +
  xlab("Production Budget ($)") +
...
```{r, echo = FALSE, eval = T, fig.alt = "Scatter plot titled Worldwide Gross vs. Budget depicting the relationship between production budget and worldwide gross revenue of films, with colors and shapes indicating genres and MPAA ratings respectively."}
ggplot(data = movies,
       aes(x = production_budget, 
           y = worldwide_gross, 
           color = genre,
