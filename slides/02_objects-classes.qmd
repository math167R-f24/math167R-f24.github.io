...
![Hierarchical diagram of atomic vector types in R](img/02_atomics.png){fig-align="center"}
...
![Hierarchical tree diagram showing file structure starting from root directory branching to folder1 and folder2, with folder1 containing three files and folder2 branching to folder3 and folder4.](images/Screen%20Shot%202023-08-15%20at%207.51.33%20AM.png)
...
![Screenshot of source editor with header, followed by plain text, followed by code chunk wrapped in tick marks](images/Screenshot%202024-01-25%20at%209.28.24%20AM.png)

## Visual Editor

![Screenshot of visual editor with header, followed by plain text, followed by code chunk](images/Screenshot%202024-01-25%20at%209.29.11%20AM.png)
