...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Five horizontal plots labeled A through E with teal 'T' and red 'H' dots connected by crisscrossing lines."
flips_long <- flips |>
  mutate(id = 1:200) |>
...
#| message: false
#| warning: false
#| fig-alt: "Side-by-side comparison of three heatmaps labeled 'Data', 'Shuffled', and 'Shuffled and reordered' showing different distributions of red and blue shading."
library(tidyverse)
library(ggplot2)
...
#| message: false
#| warning: false
#| fig-alt: "Three heatmaps showing data arrangements: original, shuffled, and shuffled and reordered"
library(tidyverse)
library(ggplot2)
data_dat <- data.frame(carrier = carrier, 
                       y = alt_y) |>
...
#| eval: true
#| echo: true
#| fig-alt: Histogram of test_stats_alt with a bell-shaped distribution and a vertical purple line slightly above zero."
...
#| eval: true
#| echo: true
#| fig-alt: "Histogram of test_stats_alt with a purple vertical line at approximately -2."
...
#| eval: true
#| echo: false
#| fig-alt: "Line graph showing power versus true population mean for three sample sizes: n=10 (red), n=20 (green), and n=5 (blue)."
one_sample_z_power <- function(mu_a, alpha, n) {
  z <- qnorm(1 - alpha / 2)
  return(1 - pnorm(z - mu_a * sqrt(n)) + pnorm(-z - mu_a * sqrt(n)))
}
...
#| echo: false
#| cache: true
#| fig-alt: "Line graph showing power vs. true population mean with curves for n = 5, n = 10, and n = 20."
simulate_test <- function(mu_a, alpha, n) {
  Xbar <- mean(rnorm(n, mean = mu_a, sd = 1))
  Z_score <- Xbar * sqrt(n)
  return(abs(Z_score) > qnorm(1 - alpha / 2))
...
#| eval: true
#| echo: true
#| fig-alt: "Matrix of 64 scatter plots arranged in an 8x8 grid, with rows and columns labeled var 1 to var 8"
