...
#| message: FALSE
#| warning: FALSE
#| fig.alt: "Scatter plot with blue and red dots, where blue dots (TRUE) are organized in a circle, and red dots represent points outside the circle."
library(tidyverse)
library(ggplot2)
random_points <- data.frame(x = runif(500, -1, 1),
                            y = runif(500, -1, 1))
...
#| eval: TRUE
#| cache: TRUE
#| fig.alt: "Graph titled 'A one-dimensional random walk' with x-axis labeled Step and y-axis labeled x showing a zig-zagging line with an overall upward trend from 0 to 100 steps"
...
#| eval: TRUE
#| cache: TRUE
#| fig.alt: "Line graph titled 'A one-dimensional random walk' showing random changes in x values from 0 to 100 steps, trending generally downward"
...
#| eval: TRUE
#| cache: TRUE
#| fig.alt: "A step-like scatter plot with x-axis from -10 to 0 and y-axis from 0 to 8, showing color-coded steps from black to light blue indicating values from 0 to 100."
library(ggplot2)
...
#| eval: TRUE
#| cache: TRUE
#| fig.alt: "An animated two-dimensional random walk graph with a path varying from light blue to dark blue and labeled x and y axes."
library(gganimate)
...
#| eval: TRUE
#| cache: TRUE
#| fig.alt: "Line graph showing the relationship between the number of steps and the mean returns to x = 0."
set.seed(123)
ns <- c(10, 20, 50, 100, 200, 500, 1000) 
expected_returns <- 
  vapply(ns, 
...
#| eval: TRUE
#| cache: TRUE
#| fig.alt: "Graph showing the relationship between the number of steps and mean visits to x = 10, with a downward sloping line from 1.0 mean visits at 0 steps to below 0.2 mean visits at 20 steps. "
set.seed(123)
ns <- 1:20
# for each n, estimate the proportion of random walks that do NOT return
# to zero, using simulations
