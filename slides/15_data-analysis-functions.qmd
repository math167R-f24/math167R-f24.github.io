...
![](images/hardcover.png){fig-alt="\"Top five hardcover fiction books list featuring covers of 'Counting Miracles', 'Intermezzo', 'The Women', 'Here One Moment', and 'Playground'.\""}
...
![](images/bestsellers-api-info.png){fig-alt="Books API documentation detailing Best Sellers Lists Services with sample endpoints.\""}

## API rate limits

In order to prevent users from abusing these services, many APIs have limits on how quickly a user can download data.

![](images/bestsellers-api.png){fig-alt="FAQ text about API call limits and contact information."}
...
#| out.width: "100%"
#| fig.align: "center"
#| fig.alt: "Line graph showing recent NYT Best Seller ranks for various books from past twelve weeks, with color-coded lines for each book."
library(ggplot2)
