...
![](images/Screenshot%202024-02-20%20at%2010.24.44%20AM.png){fig-alt="Smoky air over San Francisco viewed from Twin Peaks."}
...
#| out.width: "100%"
#| fig.align: "center"
#| fig-alt: "Histogram of PM 2.5 levels titled 'Jan 1' showing highest frequency for low PM 2.5 values."
...
#| out.width: "100%"
#| fig.align: "center"
#| #| fig-alt: "Histogram of PM 2.5 levels titled 'September 19' showing highest frequency for low PM 2.5 values."
...
#| out.width: "100%"
#| fig.align: "center"
#| fig-alt: "Scatter plot of SITE_LATITUDE versus SITE_LONGITUDE with dots colored by daily AQI values for September 19."
...
#| out.width: "100%"
#| fig.align: "center"
#| fig.alt: "Scatter plot of SITE_LATITUDE versus SITE_LONGITUDE with dots colored by daily AQI values for January 1."
...
![](https://upload.wikimedia.org/wikipedia/commons/8/83/Equirectangular_projection_SW.jpg){fig-alt="World map with continents displaying various geographical features and a rectangular grid system."}
...
#| echo: TRUE
#| eval: TRUE
#| fig.alt: "Scatter plot showing points distributed from 34°N to 42°N latitude and 124°W to 116°W longitude."
...
#| out.width: "100%"
#| fig.align: "center"
#| fig.alt: "Map of California with several black dots representing data points scattered across various locations within the state."
ggplot() +
  geom_sf(data = CA_sf) +
...
#| out.width: "100%"
#| fig.align: "center"
#| fig.alt: "Map of California with color-coded dots representing Daily AQI values. Colors range from purple (low) to yellow (high)."
ggplot() +
  geom_sf(data = CA_sf) +
  geom_sf(data = sep19_pm_2_5, 
...
#| out.width: "100%"
#| fig.align: "center"
#| fig.alt: "Four maps of California showing AQI values from September 19 to September 22, 2023, with varying colored dots."
pm_2_5 <- pm_2_5 |>
  st_as_sf(
...
#| out.width: "100%"
#| fig.align: "center"
#| fig.alt: "Choropleth map of California displaying various AQI levels across counties with colors from purple to yellow."
sep19_county_means <- CA_counties_sf |>
...
#| out.width: "100%"
#| fig.align: "center"
#| fig.alt: "Animated scatterplot of countries with GDP per capita on x-axis and life expectancy on y-axis. The animation shows how the data change over time. The size of each point represents population and the color of each point represents different countries."
library(gapminder)
library(gganimate)
...
#| out.width: "100%"
#| fig.align: "center"
#| fig.alt: "Animated map of AQI in California over days in September 2023. The animation shows each county in California with color representing AQI. Over time we see that the level of AQI varies quite a bit from county to county."
pm_2_5 <- readr::read_csv("https://math167r-s24.github.io/static/CA_PM2_5_2023.csv")
pm_2_5 <- pm_2_5 |>
  mutate(Date = mdy(Date)) |>
  filter(month(Date) == 9)
