...
![](images/alice-bob.jpeg){fig-alt="Screenshot of a tweet by Daniel Litt (@littmath) detailing a coin flip probability problem and a poll result. The text of the problem is as follows: Flip a fair coin 100 times. It gives a sequence of heads H and tails T. For each HH in the sequence, Alice gets a point; for each HT, Bob gets a point. For example for the sequence THHHT, Alice gets 2 points and Bob gets 1 point. Who is more likely to win?"}
...
#| echo: FALSE
#| eval: TRUE
#| fig.alt: "Histogram of scores for Alice and Bob, showing overlapping red and teal bell-shaped distributions. Alice's scores exhibit higher variance."
library(ggplot2)
ggplot() +
...
#| eval: TRUE
#| cache: TRUE
#| fig.alt: "Line graph showing sample mean of maximums in black and theoretical expectation in red, both trending upwards from 3 to 7 as 'n' increases from 0 to 1000."
plot(n_values, max_by_n,
     type = "l",
     xlab = "n", ylab = "Maximum",
     main = paste0("Sample mean of maximums (black)",
