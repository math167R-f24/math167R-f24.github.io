...
![(Devore)](images/Screenshot%202023-10-28%20at%2010.30.53%20AM.png){fig-alt="Graph of standard normal distribution for two-tailed z-test with P-value formula and labeled calculated z-scores."}
...
![[Lea et al. (2007)](https://link.springer.com/article/10.3758/BF03194119)](images/tim_bob.png){fig-alt="Two side-by-side black-and-white headshots of men with neutral expressions, one with wavy hair and a goatee, the other bald with a goatee."}
