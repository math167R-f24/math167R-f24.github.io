...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Matrix of scatter plots showing relationships between mpg, hp, and wt"
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot showing the relationship between speed (mph) and stopping distance (ft) with blue dots indicating data points."
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot showing the positive correlation between speed (mph) and stopping distance (ft) with blue data points and a red trend line."
plot(dist ~ speed, data = cars,
     xlab = "Speed (mph)",
     ylab = "Stopping Distance (ft)", 
     pch  = 16, col  = "blue")
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot with data points and a red trend line showing a positive correlation between x and y axes.s"
library(tidyverse)
set.seed(123)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot with black dots and a red trend line, showing a positive correlation."
library(tidyverse)
set.seed(123)
x <- runif(n = 40, min = 0, max = 5)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot showing residuals versus speed in mph, with a horizontal red line at zero."
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot of residuals against x with a red horizontal line at y equals 0."
set.seed(123)
x <- runif(n = 40, min = 0, max = 5)
y <- rnorm(n = 40, mean = 1 + 2 * x)
lm_res <- lm(y ~ x)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot of residuals versus variable x with a horizontal red reference line at y = 0."
set.seed(123)
x <- runif(n = 40, min = 0, max = 5)
y <- rnorm(n = 40, mean = (x - 2.5) ^ 2 + x)
lm_res <- lm(y ~ x)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot with black data points trending upward and a red regression line indicating a positive correlation between x (0 to 5) and y (0.0 to 12.5)."
set.seed(123)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot with black data points and a red trend line, x-axis labeled 'x' and y-axis labeled 'y'."
set.seed(125)
x <- runif(n = 80, min = 0, max = 5)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Normal Q-Q Plot with sample quantiles on the y-axis and theoretical quantiles on the x-axis. Points mostly follow the reference line from bottom-left to top-right."
lm_res <- lm(dist ~ speed, cars)
qqnorm(resid(lm_res))
qqline(resid(lm_res))
```
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Normal Q-Q plot comparing sample quantiles to theoretical quantiles with points clustering around a diagonal line. "
set.seed(123)
x <- runif(n = 80, min = 0, max = 5)
y <- rnorm(n = 80, mean = 1 + 2 * x)
lm_res <- lm(y ~ x)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Normal Q-Q plot with sample quantiles versus theoretical quantiles. Points do not fall on a line."
set.seed(125)
x <- runif(n = 80, min = 0, max = 5)
y <- 1 + 2 * x + rt(n = 80, df = 2)
lm_res <- lm(y ~ x)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot showing black dots with a red trend line indicating a positive correlation between x and y values."
set.seed(123)
x <- runif(n = 80, min = 0, max = 5)
y <- rnorm(n = 80, mean = 1 + 2 * x)
lm_res <- lm(y ~ x)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot graph with labeled axes and a red line of best fit showing a positive linear relationship."
set.seed(123)
x <- runif(n = 80, min = 0, max = 5)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot with black dots showing residuals across a range of x-values from 0 to 5, with a red horizontal line at y=0."
set.seed(123)
x <- runif(n = 80, min = 0, max = 5)
y <- rnorm(n = 80, mean = 1 + 2 * x)
lm_res <- lm(y ~ x)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot of residuals versus x with many black dots and a horizontal red line at residuals equal to 0. Points are not normally distributed around the line."
set.seed(123)
x <- runif(n = 80, min = 0, max = 5)
y <- rnorm(n = 80, mean = 1 + 2 * x, sd = .4 * x)
lm_res <- lm(y ~ x)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot comparing flipper length in millimeters (x-axis) versus body mass in grams (y-axis) with a blue regression line showing a positive correlation"
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot of residuals versus flipper length for three penguin species: Adelie (black dots), Chinstrap (red dots), and Gentoo (green dots)."
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot showing penguin body mass versus flipper length for Adelie, Chinstrap, and Gentoo species."
ggplot(penguins,
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot showing the relationship between flipper length and body mass for three penguin species: Adelie (red), Chinstrap (green), and Gentoo (blue). We have separate regression lines for each species."
ggplot(penguins,
       mapping = aes(x =  flipper_length_mm,
                     y = body_mass_g, 
                     color = species)) +
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot showing the difference between observed and predicted values against flipper length for Adelie (black dots), Chinstrap (red dots), and Gentoo (green dots) penguins. The residuals are now clearly centered around the horizontal y = 0 line."
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot showing relationship between flipper length and body mass for Adelie, Chinstrap, and Gentoo penguins with respective trend lines."
ggplot(penguins,
       mapping = aes(x =  flipper_length_mm,
                     y = body_mass_g, 
                     color = species)) +
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Scatter plot titled Residuals vs Fitted showing fitted values on the x-axis and residuals on the y-axis with a red trend line and labeled data points."
plot(my_lm,  which = 1)
```
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Q-Q plot comparing theoretical quantiles to standardized residuals with some labeled data points."
plot(my_lm,  which = 2)
```
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Scatter plot of standardized residuals against fitted values with a red trend line and labeled points for Chrysler Imperial, Fiat 128, and Toyota Corolla."
plot(my_lm,  which = 3)
```
...
#| eval: TRUE
#| cache: TRUE
#| fig-alt: "Scatter plot titled 'Residuals vs Leverage' with labeled data points for 'Toyota Corolla,' 'Chrysler Imperial,' and 'Maserati Bora.' Plot shows standardized residuals on the vertical axis and leverage on the horizontal axis, with Cook's distance thresholds indicated by dashed lines and a red regression line."
plot(my_lm,  which = 5)
```
...
#| eval: FALSE
#| cache: TRUE
#| fig-alt: "Scatter plot of actual vs. fitted values with black data points and a red dashed line of best fit, showing a positive correlation."
library(ggplot2)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot with an upward-sloping red trend line, data points dispersed roughly linearly, x-axis labeled x and y-axis labeled y"
library(tidyverse)
x <- runif(n = 40, min = 0, max = 5)
y <- rnorm(n = 40, mean = 1 + 2 * x)
lm_res <- lm(y ~ x)
...
#| fig.align: "center"
#| fig-cap: ""
#| fig-alt: "Scatter plot with black data points and a red diagonal line of best fit showing an increasing trend. The x-axis ranges from 0 to 5, and the y-axis from 0 to 200."
x <- runif(n = 40, min = 0, max = 5)
y <- rnorm(n = 40, mean = 1 + 2 * x^3)
lm_res <- lm(y ~ x)
ggplot(mapping = aes(x = x, y = y)) +
